...
# ----------------------------------------
# If SYS_GCLK is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2018.07.18.13:29:03
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/SYS_GCLK_altclkctrl_0.v" -work altclkctrl_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/SYS_GCLK.v"                                           
}
