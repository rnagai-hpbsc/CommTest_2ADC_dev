...
module TestRO_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> fifo_0_out_agent:cp_channel
	...
	wire    [8:0] cmd_mux_003_src_channel;                                                            // cmd_mux_003:src_channel -> fifo_1_out_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> write_en_pio_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> exttrg_0_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> fifo_0_in_csr_agent:cp_valid
	wire  [109:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> fifo_0_in_csr_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // fifo_0_in_csr_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> fifo_0_in_csr_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> fifo_0_in_csr_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> fifo_0_in_csr_agent:cp_endofpacket
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> fifo_1_in_csr_agent:cp_valid
	wire  [109:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> fifo_1_in_csr_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // fifo_1_in_csr_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> fifo_1_in_csr_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> fifo_1_in_csr_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> fifo_1_in_csr_agent:cp_endofpacket
	...
	wire          fifo_0_in_csr_agent_rp_valid;                                                       // fifo_0_in_csr_agent:rp_valid -> router_009:sink_valid
	wire  [109:0] fifo_0_in_csr_agent_rp_data;                                                        // fifo_0_in_csr_agent:rp_data -> router_009:sink_data
	wire          fifo_0_in_csr_agent_rp_ready;                                                       // router_009:sink_ready -> fifo_0_in_csr_agent:rp_ready
	wire          fifo_0_in_csr_agent_rp_startofpacket;                                               // fifo_0_in_csr_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          fifo_0_in_csr_agent_rp_endofpacket;                                                 // fifo_0_in_csr_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          fifo_1_in_csr_agent_rp_valid;                                                       // fifo_1_in_csr_agent:rp_valid -> router_010:sink_valid
	wire  [109:0] fifo_1_in_csr_agent_rp_data;                                                        // fifo_1_in_csr_agent:rp_data -> router_010:sink_data
	wire          fifo_1_in_csr_agent_rp_ready;                                                       // router_010:sink_ready -> fifo_1_in_csr_agent:rp_ready
	wire          fifo_1_in_csr_agent_rp_startofpacket;                                               // fifo_1_in_csr_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          fifo_1_in_csr_agent_rp_endofpacket;                                                 // fifo_1_in_csr_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [109:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> cmd_mux_007:sink0_data
	wire          cmd_demux_001_src3_ready;                                                           // cmd_mux_007:sink0_ready -> cmd_demux_001:src3_ready
	wire    [8:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_007:sink0_channel
	...
	wire          cmd_demux_001_src4_valid;                                                           // cmd_demux_001:src4_valid -> cmd_mux_008:sink0_valid
	wire  [109:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> cmd_mux_008:sink0_data
	wire          cmd_demux_001_src4_ready;                                                           // cmd_mux_008:sink0_ready -> cmd_demux_001:src4_ready
	wire    [8:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> cmd_mux_008:sink0_channel
	wire          cmd_demux_001_src4_startofpacket;                                                   // cmd_demux_001:src4_startofpacket -> cmd_mux_008:sink0_startofpacket
	wire          cmd_demux_001_src4_endofpacket;                                                     // cmd_demux_001:src4_endofpacket -> cmd_mux_008:sink0_endofpacket
	...
	wire  [109:0] rsp_demux_007_src0_data;                                                            // rsp_demux_007:src0_data -> rsp_mux_001:sink3_data
	wire          rsp_demux_007_src0_ready;                                                           // rsp_mux_001:sink3_ready -> rsp_demux_007:src0_ready
	wire    [8:0] rsp_demux_007_src0_channel;                                                         // rsp_demux_007:src0_channel -> rsp_mux_001:sink3_channel
	...
	wire          rsp_demux_008_src0_valid;                                                           // rsp_demux_008:src0_valid -> rsp_mux_001:sink4_valid
	wire  [109:0] rsp_demux_008_src0_data;                                                            // rsp_demux_008:src0_data -> rsp_mux_001:sink4_data
	wire          rsp_demux_008_src0_ready;                                                           // rsp_mux_001:sink4_ready -> rsp_demux_008:src0_ready
	wire    [8:0] rsp_demux_008_src0_channel;                                                         // rsp_demux_008:src0_channel -> rsp_mux_001:sink4_channel
	wire          rsp_demux_008_src0_startofpacket;                                                   // rsp_demux_008:src0_startofpacket -> rsp_mux_001:sink4_startofpacket
	wire          rsp_demux_008_src0_endofpacket;                                                     // rsp_demux_008:src0_endofpacket -> rsp_mux_001:sink4_endofpacket
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> onchip_memory2_0_s1_cmd_width_adapter:in_channel
	...
	wire    [8:0] onchip_memory2_0_s1_cmd_width_adapter_src_channel;                                  // onchip_memory2_0_s1_cmd_width_adapter:out_channel -> onchip_memory2_0_s1_agent:cp_channel
	...
	wire    [8:0] router_006_src_channel;                                                             // router_006:src_channel -> onchip_memory2_0_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] onchip_memory2_0_s1_rsp_width_adapter_src_channel;                                  // onchip_memory2_0_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire          fifo_0_in_csr_agent_rdata_fifo_src_valid;                                           // fifo_0_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] fifo_0_in_csr_agent_rdata_fifo_src_data;                                            // fifo_0_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          fifo_0_in_csr_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_007:in_0_ready -> fifo_0_in_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> fifo_0_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> fifo_0_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // fifo_0_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> fifo_0_in_csr_agent:rdata_fifo_sink_error
	wire          fifo_1_in_csr_agent_rdata_fifo_src_valid;                                           // fifo_1_in_csr_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] fifo_1_in_csr_agent_rdata_fifo_src_data;                                            // fifo_1_in_csr_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          fifo_1_in_csr_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_008:in_0_ready -> fifo_1_in_csr_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> fifo_1_in_csr_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> fifo_1_in_csr_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // fifo_1_in_csr_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> fifo_1_in_csr_agent:rdata_fifo_sink_error
