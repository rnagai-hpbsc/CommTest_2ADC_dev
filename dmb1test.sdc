...
create_generated_clock -name {aclk2} -source [get_pins {ADC_PLL2|adc_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|vco0ph[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 1 -master_clock {gaclk2} [get_pins {ADC_PLL2|adc_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 
...
set_false_path  -from  [get_clocks {aclk1}]  -to  [get_clocks {aclk2}]
set_false_path  -from  [get_clocks {aclk2}]  -to  [get_clocks {aclk1}]
