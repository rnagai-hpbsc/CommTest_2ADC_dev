...
create_clock -name {IF_SAD_CKO1} -period 4.000 -waveform { 0.000 2.000 } [get_ports {IF_SAD_CKO1}]
create_clock -name {IF_SAD_CKO2} -period 4.000 -waveform { 0.000 2.000 } [get_ports {IF_SAD_CKO2}]
...
create_generated_clock -name {A1|sys_pll_inst|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} -source [get_pins {A1|sys_pll_inst|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|refclkin}] -duty_cycle 50/1 -multiply_by 50 -divide_by 2 -master_clock {IF_SYS_CLK} [get_pins {A1|sys_pll_inst|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]}] 
create_generated_clock -name {A1|sys_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk} -source [get_pins {A1|sys_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|vco0ph[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 5 -master_clock {A1|sys_pll_inst|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} [get_pins {A1|sys_pll_inst|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 
create_generated_clock -name {A1|sys_pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk} -source [get_pins {A1|sys_pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|vco0ph[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 2 -master_clock {A1|sys_pll_inst|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} [get_pins {A1|sys_pll_inst|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] 
...
set_clock_uncertainty -rise_from [get_clocks {IF_SYS_CLK}] -rise_to [get_clocks {IF_SYS_CLK}]  0.130  
set_clock_uncertainty -rise_from [get_clocks {IF_SYS_CLK}] -fall_to [get_clocks {IF_SYS_CLK}]  0.130  
set_clock_uncertainty -fall_from [get_clocks {IF_SYS_CLK}] -rise_to [get_clocks {IF_SYS_CLK}]  0.130  
set_clock_uncertainty -fall_from [get_clocks {IF_SYS_CLK}] -fall_to [get_clocks {IF_SYS_CLK}]  0.130  
...
set_clock_groups -asynchronous -group [get_clocks {IF_SYS_CLK}] 
set_clock_groups -asynchronous -group [get_clocks {IF_SAD_CKO1}] 
set_clock_groups -asynchronous -group [get_clocks {IF_SAD_CKO2}]
